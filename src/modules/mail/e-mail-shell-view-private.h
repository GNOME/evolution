...
enum {
	MAIL_SEARCH_SUBJECT_OR_ADDRESSES_CONTAIN = -20,
	MAIL_SEARCH_SUBJECT_CONTAINS = -19,
	MAIL_SEARCH_SENDER_CONTAINS = -18,
	MAIL_SEARCH_RECIPIENTS_CONTAIN = -17,
	MAIL_SEARCH_MESSAGE_CONTAINS = -16,
	MAIL_SEARCH_BODY_CONTAINS = -15,
	MAIL_SEARCH_FREE_FORM_EXPR = -14,
	MAIL_SEARCH_ADVANCED = -13,
