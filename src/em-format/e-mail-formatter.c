...
e_mail_formatter_class_init (EMailFormatterClass *class)
{
	...
	properties[PROP_IMAGE_LOADING_POLICY] =
		g_param_spec_enum (
			"image-loading-policy", NULL, NULL,
