...
e_mail_signature_combo_box_class_init (EMailSignatureComboBoxClass *class)
{
	...
	/**
	 * EMailSignatureComboBox:identity-uid
	 **/
	...
	/**
	 * EMailSignatureComboBox:identity-name
	 **/
	properties[PROP_IDENTITY_NAME] =
		g_param_spec_string (
			"identity-name",
			NULL, NULL,
			NULL,
	...
	/**
	 * EMailSignatureComboBox:identity-address
	 **/
	properties[PROP_IDENTITY_ADDRESS] =
		g_param_spec_string (
			"identity-address",
			NULL, NULL,
			NULL,
	...
	/**
	 * EMailSignatureComboBox:registry
	 **/
					   ...
					   gboolean can_emit_changed)
{
	...
	g_object_notify_by_pspec (G_OBJECT (combo_box), properties[PROP_IDENTITY_UID]);
					    ...
					    gboolean can_emit_changed)
{
	...
	g_object_notify_by_pspec (G_OBJECT (combo_box), properties[PROP_IDENTITY_NAME]);
					       ...
					       gboolean can_emit_changed)
{
	...
	g_object_notify_by_pspec (G_OBJECT (combo_box), properties[PROP_IDENTITY_ADDRESS]);
