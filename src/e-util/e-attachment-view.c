                                      ...
                                      GdkEventButton *event)
{
	...
	if (button == GDK_BUTTON_PRIMARY && gdk_event_get_event_type ((GdkEvent *) event) == GDK_BUTTON_PRESS) {
		GList *list, *iter;
		gboolean busy = FALSE;
	...
	if (button == GDK_BUTTON_SECONDARY && gdk_event_get_event_type ((GdkEvent *) event) == GDK_BUTTON_PRESS) {
